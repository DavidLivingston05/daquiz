        ...
        <div className="w-full max-w-md bg-white dark:bg-[#141A26] border border-[#EAE0D0] dark:border-[#232E42] rounded-3xl p-6 sm:p-8 shadow-xl shadow-[#2C1810]/5 space-y-6 animate-fadeIn transition-colors">
          ...
          <div className="text-left space-y-1.5">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FAF3E0] dark:bg-amber-500/15 border border-[#E8D8B8] dark:border-amber-500/30 text-[#8C6B1B] dark:text-amber-300 text-xs font-black uppercase tracking-wider">
              <ShieldCheck className="w-3.5 h-3.5 text-[#D49020] dark:text-amber-400" />
              <span>Admin Portal</span>
            </div>
            <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Login to your account</h1>
          ...
          {/* Quick link to Home */}
          <div className="border-t border-[#EAE0D0] dark:border-[#232E42] pt-4 text-center">
            <a
              href="/"
              className="text-xs text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white font-semibold transition-colors"
            >
    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-12 animate-fadeIn">
      ...
      <div className="warm-card rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-[#FAF3E0] dark:bg-amber-500/15 border border-[#E8D8B8] dark:border-amber-500/30 text-[#8C6B1B] dark:text-amber-300 flex items-center justify-center shadow-sm">
            <ShieldCheck className="w-6 h-6 text-[#D49020] dark:text-amber-400" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">DaQuiz Admin Control Center</h1>
              <span className="text-[10px] font-black px-2 py-0.5 rounded-md bg-[#FAF3E0] dark:bg-amber-500/15 text-[#8C6B1B] dark:text-amber-300 border border-[#E8D8B8] dark:border-amber-500/30 uppercase">
                PRO
              </span>
            </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-[#FBF8F4] dark:bg-[#1A2232] hover:bg-white dark:hover:bg-[#20293D] text-slate-700 dark:text-slate-200 text-xs font-extrabold border border-[#EAE0D0] dark:border-[#232E42] flex items-center gap-1.5 transition-all shadow-sm"
          >
            <RefreshCw className="w-3.5 h-3.5 text-[#D49020] dark:text-amber-400" />
            <span>Sync Data</span>
          </button>

          <button
            onClick={handleAdminLogout}
            className="px-4 py-2.5 rounded-xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/50 text-rose-700 dark:text-rose-300 text-xs font-extrabold border border-rose-200 dark:border-rose-800 flex items-center gap-1.5 transition-all"
      ...
      <div className="flex flex-wrap items-center gap-2 p-1.5 rounded-2xl bg-[#F4EDE2] dark:bg-[#1A2232] border border-[#E5DAC8] dark:border-[#232E42]">
        <button
        ...
        <div className="space-y-4">
          ...
          <div className="warm-card p-4 rounded-2xl flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-1 items-center gap-2 min-w-[240px]">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] focus:border-[#D49020] focus:bg-white dark:focus:bg-[#141A26] rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none transition-colors"
                />
              </div>
              <button
                onClick={loadQuestions}
                className="px-4 py-2 rounded-xl btn-modern-gold text-white text-xs font-extrabold shadow-sm transition-all"
              >
                Search
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="px-3 py-2 bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] rounded-xl text-xs text-slate-700 dark:text-slate-200 font-bold focus:outline-none"
              >
              ...
              <button
                onClick={loadQuestions}
                className="p-2 rounded-xl bg-[#FBF8F4] dark:bg-[#1A2232] hover:bg-white dark:hover:bg-[#20293D] border border-[#EAE0D0] dark:border-[#232E42] text-slate-700 dark:text-slate-200 transition-colors shadow-sm"
                title="Refresh Questions"
              >
                <RefreshCw className={`w-4 h-4 text-[#D49020] dark:text-amber-400 ${loadingQuestions ? 'animate-spin' : ''}`} />
              </button>
            </div>
          </div>
          ...
          {loadingQuestions ? (
            ...
            <div className="warm-card p-12 rounded-3xl text-center space-y-3">
              <p className="text-slate-600 dark:text-slate-400 text-sm font-semibold">No questions found matching your query.</p>
              <button
                onClick={() => setActiveTab('create')}
                className="px-5 py-2.5 rounded-2xl btn-modern-gold text-white text-xs font-extrabold shadow-md transition-all"
              >
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="px-2.5 py-0.5 rounded-md bg-amber-100 dark:bg-amber-500/20 text-amber-900 dark:text-amber-200 border border-amber-200 dark:border-amber-500/30 text-[10px] font-black uppercase">
                        {q.difficulty}
                      </span>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1 rounded-xl bg-[#FBF8F4] dark:bg-[#1A2232] hover:bg-white dark:hover:bg-[#20293D] border border-[#EAE0D0] dark:border-[#232E42] text-slate-700 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white transition-colors flex items-center gap-1.5 text-xs font-extrabold shadow-sm"
                        title="Edit Question"
                      >
                        <Edit className="w-3.5 h-3.5 text-[#D49020] dark:text-amber-400" />
                        <span>Edit</span>
                      </button>
                      <button
                        onClick={() => handleDeleteQuestion(q.id, q.question.en)}
                        className="px-3 py-1 rounded-xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/50 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300 transition-colors flex items-center gap-1.5 text-xs font-extrabold"
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-extrabold text-slate-900 dark:text-white leading-snug">{q.question.en}</p>
                    {q.question.ta && (
                      <p className="text-xs font-tamil text-slate-600 dark:text-slate-300 leading-relaxed font-semibold">{q.question.ta}</p>
                    )}
                  </div>
                    ...
                    {q.options?.map((opt: any, idx: number) => (
                      <div
                        ...
                        className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                          opt.isCorrect
                            ? 'bg-[#FAF3E0] dark:bg-amber-500/15 border-[#D49020] dark:border-amber-500/50 text-[#3D2F14] dark:text-amber-200 font-bold shadow-sm'
                            : 'bg-[#FBF8F4] dark:bg-[#1A2232] border-[#EAE0D0] dark:border-[#232E42] text-slate-700 dark:text-slate-300'
                        }`}
                      >
                        <span className="font-black text-[10px] uppercase">{String.fromCharCode(65 + idx)}:</span>
                        <div className="truncate">
                          <span>{opt.text?.en}</span>
                          {opt.text?.ta && <span className="text-slate-500 dark:text-slate-400 font-tamil ml-1">({opt.text.ta})</span>}
                        </div>
                        {opt.isCorrect && <Check className="w-3.5 h-3.5 ml-auto text-[#D49020] dark:text-amber-400 stroke-[3] shrink-0" />}
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {activeTab === 'create' && (
        <form onSubmit={handleCreateSubmit} className="warm-card rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl">
          <div className="border-b border-[#EAE0D0] dark:border-[#232E42] pb-4 flex items-center justify-between">
            <h2 className="text-lg font-black text-slate-900 dark:text-white flex items-center gap-2">
              <PlusCircle className="w-5 h-5 text-[#D49020] dark:text-amber-400" />
              <span>Create New Bilingual Question</span>
            </h2>
            <span className="text-xs font-bold text-[#8C6B1B] dark:text-amber-300 bg-[#FAF3E0] dark:bg-amber-500/15 px-3 py-1 rounded-full border border-[#E8D8B8] dark:border-amber-500/30">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Question Text (English) *</label>
              <textarea
                required
                rows={2}
                value={questionEn}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Question Text (தமிழ் / Tamil) *</label>
              <textarea
                required
                rows={2}
                value={questionTa}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-[#8C6B1B] dark:text-amber-300 font-extrabold bg-[#FAF3E0] dark:bg-amber-500/15 border border-[#E8D8B8] dark:border-amber-500/30 px-3 py-0.5 rounded-full">
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-2xl border-2 transition-all cursor-pointer ${
                      isSelected
                        ? 'bg-[#FAF3E0] dark:bg-amber-500/15 border-[#D49020] dark:border-amber-500/50 shadow-md ring-2 ring-[#D49020]/20'
                        : 'bg-[#FBF8F4] dark:bg-[#1A2232] border-[#EAE0D0] dark:border-[#232E42] hover:border-[#D49020]/50 hover:bg-white dark:hover:bg-[#20293D]'
                    }`}
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-xs font-black flex items-center gap-1.5 transition-all ${
                          isSelected
                            ? 'btn-modern-gold text-white shadow-sm'
                            : 'bg-[#EAE0D0] dark:bg-[#232E42] text-slate-600 dark:text-slate-300'
                        }`}
                      >
                    ...
                    >
                      <input
                        ...
                        className={`w-full px-3.5 py-2 text-xs rounded-xl transition-colors font-medium ${
                          isSelected
                            ? 'bg-white dark:bg-[#141A26] border-2 border-[#D49020] text-slate-900 dark:text-white'
                            : 'bg-white dark:bg-[#141A26] border border-[#EAE0D0] dark:border-[#232E42] text-slate-800 dark:text-slate-200'
                        }`}
                      />
                      <input
                        type="text"
          ...
          <button
            ...
            className="w-full py-4 px-6 rounded-2xl btn-modern-gold font-extrabold text-sm shadow-md hover:scale-[1.005] transition-all flex items-center justify-center gap-2"
          >
            {createSubmitting ? (
              <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
            ) : (
      ...
      {activeTab === 'users' && (
        <div className="space-y-4">
          <div className="warm-card p-4 rounded-2xl flex items-center justify-between gap-3">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] focus:border-[#D49020] focus:bg-white dark:focus:bg-[#141A26] rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none"
              />
            </div>
            <button
              onClick={loadUsers}
              className="px-4 py-2 rounded-xl bg-[#FBF8F4] dark:bg-[#1A2232] hover:bg-white dark:hover:bg-[#20293D] border border-[#EAE0D0] dark:border-[#232E42] text-slate-700 dark:text-slate-200 text-xs font-extrabold flex items-center gap-1.5 shadow-sm transition-all"
            >
              <RefreshCw className={`w-3.5 h-3.5 text-[#D49020] dark:text-amber-400 ${loadingUsers ? 'animate-spin' : ''}`} />
              <span>Refresh</span>
            </button>
          </div>
          ...
          {loadingUsers ? (
            ...
            <div className="warm-card p-12 rounded-3xl text-center text-slate-500 dark:text-slate-400 text-xs font-semibold">
            ...
            <div className="warm-card rounded-2xl overflow-x-auto shadow-sm">
              <table className="w-full text-left text-xs">
                <thead className="bg-[#FAF3E0] dark:bg-amber-500/15 text-slate-700 dark:text-slate-200 font-black uppercase border-b border-[#EAE0D0] dark:border-[#232E42]">
                  <tr>
                ...
                <tbody className="divide-y divide-[#EAE0D0] dark:divide-[#232E42]">
                  {filteredUsers.map((u: any) => (
                    <tr key={u.id} className="hover:bg-[#FBF8F4] dark:hover:bg-[#1A2232] transition-colors">
                      <td className="p-4 font-extrabold text-slate-900 dark:text-white flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-lg bg-[#FAF3E0] dark:bg-amber-500/20 border border-[#E8D8B8] dark:border-amber-500/30 text-[#8C6B1B] dark:text-amber-300 flex items-center justify-center font-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="warm-card p-6 rounded-3xl space-y-4">
            <h3 className="font-extrabold text-slate-900 dark:text-white text-sm flex items-center gap-2">
              <Database className="w-4 h-4 text-[#D49020] dark:text-amber-400" />
              <span>Database Status</span>
            </h3>
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-2 border-b border-[#EAE0D0] dark:border-[#232E42]">
                <span className="text-slate-500 dark:text-slate-400 font-medium">Connection Status:</span>
                <span className="text-emerald-700 dark:text-emerald-300 font-extrabold">{healthData?.status || 'Active & Connected'}</span>
              </div>
              <div className="flex justify-between py-2 border-b border-[#EAE0D0] dark:border-[#232E42]">
                <span className="text-slate-500 dark:text-slate-400 font-medium">Total Questions:</span>
                <span className="text-slate-900 dark:text-white font-extrabold">{healthData?.stats?.questions || totalQuestions}</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-slate-500 dark:text-slate-400 font-medium">Uptime:</span>
                <span className="text-slate-900 dark:text-white font-mono font-bold">{healthData?.uptime || 'Live'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="warm-card p-6 rounded-3xl space-y-4">
            <h3 className="font-extrabold text-slate-900 dark:text-white text-sm flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-[#D49020] dark:text-amber-400" />
      ...
      {/* ================= EDIT QUESTION MODAL ================= */}
      {editingQuestion && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 dark:bg-black/70 backdrop-blur-sm overflow-y-auto">
          <div className="relative z-10 w-full max-w-2xl my-auto bg-white dark:bg-[#141A26] rounded-3xl border border-[#EAE0D0] dark:border-[#232E42] p-6 sm:p-8 shadow-2xl space-y-6">
            <button
            ...
            <h2 className="text-lg font-black text-slate-900 dark:text-white flex items-center gap-2">
              <Edit className="w-5 h-5 text-[#D49020] dark:text-amber-400" />
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4 text-xs">
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1">Question (English)</label>
                <textarea
                  rows={2}
                  ...
                  className="w-full px-3 py-2 bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] focus:border-[#D49020] focus:bg-white dark:focus:bg-[#141A26] rounded-xl text-slate-900 dark:text-white font-medium"
                />
              </div>

              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1">Question (Tamil)</label>
                <textarea
                  rows={2}
                  ...
                  className="w-full px-3 py-2 bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] focus:border-[#D49020] focus:bg-white dark:focus:bg-[#141A26] rounded-xl text-slate-900 dark:text-white font-tamil font-medium"
                />
              </div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-2xl border-2 transition-all cursor-pointer ${
                        isSelected
                          ? 'bg-[#FAF3E0] dark:bg-amber-500/15 border-[#D49020] dark:border-amber-500/50 shadow-sm'
                          : 'bg-[#FBF8F4] dark:bg-[#1A2232] border-[#EAE0D0] dark:border-[#232E42] hover:border-[#D49020]/40'
                      }`}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span
                          className={`px-2.5 py-0.5 rounded-lg text-[11px] font-black transition-all ${
                            isSelected ? 'bg-gradient-to-tr from-[#E8A838] to-[#B87410] text-white' : 'bg-[#EAE0D0] dark:bg-[#232E42] text-slate-700 dark:text-slate-300'
                          }`}
                        >
                          Option {String.fromCharCode(65 + idx)}
                        </span>
              ...
              <div className="flex justify-end gap-2.5 pt-3">
                <button
                  type="button"
                  onClick={() => setEditingQuestion(null)}
                  className="px-4 py-2.5 rounded-xl bg-[#FBF8F4] dark:bg-[#1A2232] border border-[#EAE0D0] dark:border-[#232E42] text-slate-700 dark:text-slate-200 font-extrabold hover:bg-white dark:hover:bg-[#20293D] transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl btn-modern-gold text-white font-extrabold shadow-sm transition-all"
                >
